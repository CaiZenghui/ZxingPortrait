...
public final class CameraManager {
    ...
    private static int MAX_FRAME_WIDTH; // = 5/8 * 1920
    private static int MAX_FRAME_HEIGHT; // = 5/8 * 1080
    ...
    public CameraManager(Context context) {
        ...
        MAX_FRAME_HEIGHT = metrics.widthPixels * 5 / 8;
        MAX_FRAME_WIDTH = metrics.heightPixels * 5 / 8;
     ...
     *
     * @param cameraId
     *            camera ID of the camera to use. A negative value means "no
     *            preference".
     */
